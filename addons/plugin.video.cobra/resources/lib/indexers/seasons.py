	...
	def _process():
		...
		for item in season_data:
			try:
				...
				set_properties({'totalepisodes': string(episode_count), 'watchedprogress': string(progress), 'cobra.extras_params': extras_params, 'cobra.options_params': options_params})
				if is_external:
