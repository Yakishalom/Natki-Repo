...
from cocoscrapers.modules import dom_parser  # switch to client.parseDOM() to rid import
	...
	def get_sources(self, name, url):
		try:
			...
			for link in urls:
				...
				self.sources_append({'provider': 'rapidmoviez', 'source': host,'seeders':0, 'name': name, 'name_info': name_info, 'quality': quality, 'language': 'en', 'url': url,
